 ...
 */
    [_BASE] = LAYOUT(
        ...
        KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , _______, _______, _______, _______, KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
                                   KC_LALT, KC_LGUI, NAVIGAT, NUMBERS, KC_SPC , KC_SPC , SYMBOLS, KC_ENT , KC_RGUI, KC_RALT
    ),
/*
 * Symbols Layer
 *
 ...
 */
    [_SYMBOLS] = LAYOUT(
      ...
      KC_GRV , _______, _______, _______, _______, _______,                                     KC_PLUS, KC_UNDS, KC_LCBR, KC_RCBR, KC_COLN, KC_DQUO,
